OC.L10N.register(
    ...
    "You should have at least one gpx/kml/tcx/igc file in your files" : "Vous devez avoir au moins un fichier gpx/kml/tcx/igc dans vos fichiers",
    "Reload and process all files in current folder" : "Recharger et analyser tous les fichiers dans le dossier courant",
    ...
    "Delete all markers and geojson files" : "Supprimer tous les fichiers de marqueurs et les geojson",
    "Delete markers and geojson files for existing gpx" : "Supprimer les fichiers de marqueurs et les geojson correspondants à des gpx existants",
    "Delete all metadata in the database" : "Supprimer les données de traces dans la base de données",
